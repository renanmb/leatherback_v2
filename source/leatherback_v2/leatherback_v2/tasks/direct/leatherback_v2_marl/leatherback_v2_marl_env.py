...
from .leatherback_v2_marl_env_cfg import LeatherbackV2MarlEnvCfg


class LeatherbackV2MarlEnv(DirectMARLEnv):
    cfg: LeatherbackV2MarlEnvCfg

    def __init__(self, cfg: LeatherbackV2MarlEnvCfg, render_mode: str | None = None, **kwargs):
